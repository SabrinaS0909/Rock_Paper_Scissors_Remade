...
def outcome(player_action, computer_action):
    ...
    if player_action == "bee":
        ...
        if computer_action == "bee":
            ...
            outcome = "This is human vs human which are both wild cards, this will be substantially different from the function we've made.", "tie"
    elif computer_action == "human":
        if player_action == "bee":
            ...
            outcome = "This is human vs human.", "tie"
    else:
        raise ValueError(f"Unexpected input: player={player_action}, computer={computer_action}")
